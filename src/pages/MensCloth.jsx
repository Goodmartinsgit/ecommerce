      ...
      <div className="bg-white min-h-screen py-8">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-primary mt-2 text-lg">
            Explore our complete collection of mens cloth.
          </p>

          {mensCloth.length === 0 ? (
            <div className="text-center mt-16">
              <p className="text-gray-600 text-lg">No mens cloth found.</p>
            </div>
          ) : (
            <>
              <p className="text-center text-gray-600 mt-4">
                Showing {mensCloth.length} product
                {mensCloth.length !== 1 ? "s" : ""}
              </p>
