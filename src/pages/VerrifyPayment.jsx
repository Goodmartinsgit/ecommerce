...
//         // Clear cart from localStorage and context after successful payment
...
//             className="bg-gray-100 text-black p-8 rounded-lg overflow-x-auto w-[90%] lg:w-[70%]"
//           >
//             <table>
//               <thead>
//                <tr>
...
//                       <td className="p-4">{item?.receiptId}</td>
...
//             whileHover={{ scale: 1.05 }}
//             whileTap={{ scale: 0.95 }}
//             onClick={() => navigate(`/receipt/${transaction_id}`)}
